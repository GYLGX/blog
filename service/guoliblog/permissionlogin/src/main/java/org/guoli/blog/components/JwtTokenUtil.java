package org.guoli.blog.components;

import io.jsonwebtoken.Claims;
import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.SignatureAlgorithm;
import org.guoli.blog.service.auth.AuthUser;
...
public class JwtTokenUtil {
    //私钥
    private static final String SECRET_KEY = "guoli-blog";

    // 过期时间 毫秒,设置默认1小时的时间过期
    private  static final long EXPIRATION_TIME = 3600000L * 5;

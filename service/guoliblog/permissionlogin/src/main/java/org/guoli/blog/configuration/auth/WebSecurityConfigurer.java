...
import org.guoli.blog.components.BCryptPasswordEncoderUtil;
import org.guoli.blog.components.DynamicPermission;
...
public class WebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers(HttpMethod.POST,"/blogoss/fileoss/uploadavatar","/user/register","/bloginfo/pageBlog/releaser/**").permitAll()
                .antMatchers(HttpMethod.GET,"/totalnumber","/carouselImg","/classificati/open","/bloginfo/getReleaseBlog/**",
                        "/edumsm/msm/send/**").permitAll()
                .antMatchers("/comment/openup/**","/ucenter/openup/**").permitAll()
                //ROLE_ADMIN可以操作任何事情
